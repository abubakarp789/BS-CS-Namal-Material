...
# 1. Load the Dataset
filename = 'Kmeans_DBScan_KNN_complex_noise.csv'
...
plt.savefig('Task1_GroundTruth_noise.png')
print("Saved Task1_GroundTruth_noise.png")
# plt.show()
...
plt.legend()
plt.savefig('Task2_KMeans_noise.png')
print("Saved Task2_KMeans_noise.png")
# plt.show()
...
plt.tight_layout()
plt.savefig('Task3_DBSCAN_noise.png')
print("Saved Task3_DBSCAN_noise.png")
# plt.show()
...
plt.tight_layout()
plt.savefig('Task4_KNN_noise.png')
print("Saved Task4_KNN_noise.png")
# plt.show()
